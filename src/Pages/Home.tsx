  ...
  return (
    loggedIn ? (
      ...
      <div className="flex flex-col items-center justify-center h-screen bg-gray-200 p-6 rounded-lg shadow-md">
        ...
        <p className="text-gray-600 mb-6">You need to be logged in to use this service.</p>
        <button onClick={handleLoginRedirect} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition">
          Go to Login
        </button>
      </div>
    )
